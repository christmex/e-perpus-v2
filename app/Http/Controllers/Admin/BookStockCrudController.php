...
/**
 * Class BookStockCrudController
 * @package App\Http\Controllers\Admin
 * @property-read \Backpack\CRUD\app\Library\CrudPanel\CrudPanel $crud
 */
class BookStockCrudController extends CrudController
{
    ...
    {
        CRUD::setModel(\App\Models\BookStock::class);
        CRUD::setRoute(config('backpack.base.route_prefix') . '/book-stock');
        CRUD::setEntityNameStrings('book stock', 'book stocks');
    }
